...
import com.niit.EcommerceBackEnd.model.Abhi;
import com.niit.EcommerceBackEnd.model.Test;
import com.niit.EcommerceBackEnd.model.Test11;
	  ...
	  public DataSource getH2DataSource()
	  {
	   ...
	   public SessionFactory getSessionFactory(DataSource dataSource)
	   {
         System.out.println("------Hibernate properties creation------");
		   ...
		   sessionBuilder.addAnnotatedClass(Abhi.class);
		   System.out.println("Abhi class created");
		   
		   sessionBuilder.addAnnotatedClass(Test11.class);
		   System.out.println("Test11 class created");
